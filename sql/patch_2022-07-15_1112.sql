...
CREATE TABLE tasker.tasks (
    ...
    base_exp int(10) UNSIGNED NOT NULL COMMENT 'minimum number of experience points for finishing the task',
    time_exp int(10) UNSIGNED NOT NULL COMMENT 'experience for finishing the task depending on time spent',
