...
CREATE TABLE tasker.tasks (
    ...
    edited DATETIME DEFAULT NULL COMMENT 'date and time when the task was edited',
    editor_id int(10) UNSIGNED DEFAULT NULL COMMENT 'ID of user who edited the task',
    deleted DATETIME DEFAULT NULL COMMENT 'date and time when the task was deleted',
    deleter_id int(10) UNSIGNED DEFAULT NULL COMMENT 'ID of user who deleted the task',
